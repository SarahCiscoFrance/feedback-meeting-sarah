    ...
    <v-card-text class="fill-height">
      <v-card class="fill-height">
        <v-card-title class="pa-1 pr-3">
          ...
          <v-spacer></v-spacer>
          <v-spacer></v-spacer>
          <v-text-field append-icon="search" label="Rechercher" single-line v-model="search"></v-text-field>
        </v-card-title>
        <v-data-table :headers="headers" :items="calls" :search="search" item-key="createdDate" :rows-per-page-items="optionsRows">
  ...
  data() {
    return {
      ...
      headers: [
        {
          text: "Dialed URI",
          value: "callHistory.RemoteNumber",
          align: "center"
        },
        ...
        {
          text: "Durée (min.)",
          value: "callHistory.Duration",
          align: "center"
        },
        {
          text: "Type d'appel",
          value: "callHistory.Direction",
          align: "center"
        },
        { text: "Protocol", value: "callHistory.Protocol", align: "center" },
        {
          text: "People Presence",
          value: "callHistory.RoomAnalytics.PeopleCount",
          align: "center"
        },
